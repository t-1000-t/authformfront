  ...
  [585],
  {
    5585: (e, s, i) => {
      ...
      var a = i(5043),
        ...
        g = i(579)
      const j = (e) => {
        let { isOpen: s, onClose: i, onSubmit: a, text: t, onChange: n, initialRef: o } = e
        return (0, g.jsxs)(c.aF, {
          isOpen: s,
          onClose: i,
          initialFocusRef: o,
          ...
          children: [
            ...
            (0, g.jsxs)(p.$, {
              children: [
                (0, g.jsx)(h.r, { children: 'Type your details' }),
                (0, g.jsx)(k.s, {}),
                (0, g.jsx)(m.c, {
                  pb: 6,
                  children: Object.keys(t).map((e, s) =>
                    (0, g.jsxs)(
                      u.MJ,
                      {
                        children: [
                          (0, g.jsx)(y.l, { children: e.charAt(0) + e.slice(1) }),
                          (0, g.jsx)(f.p, {
                            name: e,
                            value: t[e] || '',
                            ref: 0 === s ? o : null,
                ...
                (0, g.jsxs)(b.j, {
                  children: [
                    (0, g.jsx)(r.$, { colorScheme: 'blue', mr: 3, onClick: a, children: 'OK' }),
                    (0, g.jsx)(r.$, { onClick: i, children: 'Cancel' }),
                  ],
                }),
              ],
            }),
      ...
      const D = (e) => {
        ...
        return {
          isOpen: s,
          text: t,
          onOpen: (0, a.useCallback)(() => {
            ;(n(e), i(!0))
          }, [e]),
          onClose: (0, a.useCallback)(() => {
            ;(i(!1), n(e))
          }, [e]),
          onChange: (0, a.useCallback)((e, s) => {
            const { name: i, value: a } = e.target
            n((e) =>
              Array.isArray(e)
                ? e.map((e, t) => (s === t ? (0, v.A)((0, v.A)({}, e), {}, { [i]: a }) : e))
                : (0, v.A)((0, v.A)({}, e), {}, { [i]: a }),
            )
          }, []),
          setText: n,
      ...
      const S = () => {
          var e
          const { currentData: s, setHasChanged: i, cv: t } = (0, x.A)()
          ;(0, a.useEffect)(() => {
            if ('strPet' === s.section) {
              var e, a, n
              const o =
                  null !==
                    ...
                    ? e
                    : {},
                r = !(0, C.isEqual)(s.localData, o)
              i(r)
            }
            if ('strEducation' === s.section) {
              var o, r, l
              const e =
                  null !==
                    (o =
                      ...
                      void 0 === l
                        ? void 0
                        : l.education) && void 0 !== o
                    ? o
                    : {},
                a = !(0, C.isEqual)(s.localData, e)
              i(a)
            }
            if ('strContacts' === s.section) {
              var x, c, d
              const e =
                  null !==
                    (x =
              ...
              const e =
                  null !==
                    (f =
                      ...
                      void 0 === g
                        ? void 0
                        : g.competencies) && void 0 !== f
                    ? f
                    : [],
                a = !(0, C.isEqual)(s.localData, e)
              i(a)
            }
          }, [s, null === t || void 0 === t || null === (e = t.user) || void 0 === e ? void 0 : e.newData])
        },
        E = {
          borderRadius: 'full',
          w: '40px',
        ...
        A = () => {
          const { putCvInfo: e, cv: s, setCurrentData: i } = (0, x.A)(),
            c = (0, a.useRef)(null),
            { title: d } = s.user.newData,
            { isOpen: p, text: h, onOpen: k, onClose: m, onChange: u } = D(d)
          S()
          return (0, g.jsx)(t.a, {
            mb: '20px',
            children: (0, g.jsxs)(n.s, {
              mb: '20px',
              ...
              children: [
                (0, g.jsxs)(t.a, {
                  children: [
                    ...
                    (0, g.jsx)(o.D, { as: 'h2', fontSize: '22px', fontWeight: 'bold', children: d.fullname }),
                  ],
                }),
                (0, g.jsx)(r.$, {
                  sx: E,
                  ...
                  bg: 'yellow.50',
                  _hover: { bg: 'green.200' },
                  children: (0, g.jsx)(l.WM1, {}),
                }),
                (0, g.jsx)(j, {
                  isOpen: p,
                  onClose: m,
                  onSubmit: () => {
                    h.posname && h.fullname
                      ? e(h, s).then(() => {
                          const e = s.user.newData.title
                          ;(i({ section: 'strTitles', localData: e }), m())
                        })
                      : m()
                  },
                  text: h,
      ...
      var w = i(3572),
        V = i(9081)
      const B = (e) => e.charAt(0).toUpperCase() + e.slice(1),
        F = (e) =>
          e
            ? Object.entries(e).map((e) => {
                let [s, i] = e,
                  a = i
                return (
                  (s.toLowerCase().includes('email') || /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(i)) &&
                    (a = (0, g.jsx)('a', {
                  ...
                  s.toLowerCase().includes('linkedin') &&
                    (a = (0, g.jsx)('a', {
                      href: 'https://linkedin.com/in/'.concat(i),
                      target: '_blank',
                      rel: 'noopener noreferrer',
                      style: { color: 'blue', textDecoration: 'underline' },
                      children: i,
                    })),
                  s.toLowerCase().includes('own') &&
                    (a = (0, g.jsx)('a', {
                      href: 'https://'.concat(i),
                      target: '_blank',
                      rel: 'noopener noreferrer',
                  ...
                  (0, g.jsxs)(
                    V.E,
                    {
                      mb: '5px',
                      children: [
                        (0, g.jsx)(V.E, { as: 'span', children: (0, g.jsx)('i', { children: B(s) }) }),
                        ':\xa0',
                        a,
                      ],
                    },
        ...
        G = () => {
          const { putCvInfo: e, cv: s, setCurrentData: i } = (0, x.A)(),
            o = (0, a.useRef)(null),
            { contacts: c } = s.user.newData,
            { onClose: d, onOpen: p, onChange: h, text: k, isOpen: m } = D(c)
          S()
          return (0, g.jsxs)(n.s, {
            w: '100%',
            justifyContent: 'space-between',
            ...
            children: [
              (0, g.jsxs)(n.s, {
                children: [
                  (0, g.jsx)(t.a, { children: F(c) }),
                  (0, g.jsx)(j, {
                    onSubmit: () => {
                      k.email && k.linkedin && k.location && k.languages
                        ? e(k, s).then(() => {
                            ;(i({ section: 'strContacts', localData: c }), d())
                          })
                        : d()
                    },
                    onChange: h,
        ...
        R = () => {
          const { putCvInfo: e, cv: s, setCurrentData: i } = (0, x.A)(),
            { education: a } = s.user.newData,
            { onClose: o, onOpen: c, onChange: d, text: p, isOpen: h } = D(a)
          S()
          return (0, g.jsxs)(n.s, {
            direction: 'column',
            w: '100%',
            ...
            pt: '20px',
            children: [
              (0, g.jsx)(V.E, { as: 'b', fontSize: 'larger', pb: '10px', children: 'Education:' }),
              (0, g.jsxs)(n.s, {
                children: [
                  (0, g.jsxs)(t.a, {
                    children: [
                      (0, g.jsx)(t.a, { children: F(a) }),
                      (0, g.jsx)(j, {
                        isOpen: h,
                        onSubmit: () => {
                          a.diploma && a.course
                            ? e(p, s).then(() => {
                                ;(i({ section: 'strEducation', localData: a }), o())
                              })
                            : o()
                        },
                        text: p,
      ...
      const z = (e) =>
        Object.keys(e)
          .filter((e) => '_id' !== e && 'id' !== e)
          .reduce((s, i) => (0, v.A)((0, v.A)({}, s), {}, { [i]: e[i] }), {})
      var O = i(7208),
        T = i(7854)
      const I = () => {
          const { putCvInfo: e, cv: s, deleteSkillFromCv: i, setCurrentData: o } = (0, x.A)(),
            { skills: c } = s.user.newData,
            d = (0, P.d)({ position: 'top-right' }),
            p = (0, a.useRef)(null),
            [h, k] = (0, a.useState)(null),
            [m] = (0, a.useState)({ company: '...', task: '...', technologies: '...', responsibilities: '...' }),
            [u, y] = (0, a.useState)([...c]),
            { text: f, onClose: b, onOpen: v, onChange: A, isOpen: w } = D(u)
          S()
          const B = (0, a.useCallback)(
            (e, a) => {
              if (e._id) {
                const { _id: a, email: n } = s.user
                try {
                  const s = i(a, e._id, n).then((e) => e || Promise.reject(new Error('Invalid response from server')))
                  ;((0, T.L)(d, s), (0, O.vV)('Skill deleted'))
                } catch (t) {
                  ;(0, O.vV)(t('Error deleting skill', t))
                }
              } else
                (() => {
                  const e = (e) => e.filter((e, s) => s !== a)
                  ;(y(e), o({ section: 'strSkills', localData: e }))
                })()
            },
            [s.user, i],
          )
          return (
            (0, a.useEffect)(() => {
              ;((0, C.isArray)(c) && y(c[0]), y(c), null === h && o({ section: 'strSkills', localData: c }))
            }, [c]),
            (0, g.jsxs)(n.s, {
              direction: 'column',
              w: '100%',
              ...
              children: [
                (0, g.jsx)(n.s, {
                  ...
                  children: (0, g.jsx)(V.E, {
                    ...
                    fontSize: 'larger',
                    pb: '20px',
                    children: 'Commercial Experience:',
                  }),
                }),
                null !== h &&
                  (0, g.jsx)(j, {
                    ...
                    onSubmit: () => {
                      const i = f[h]
                      i.company && i.task && i.responsibilities && i.technologies
                        ? e(f, s).then(() => {
                            const e = s.user.newData.skills
                            ;(o({ section: 'strSkills', localData: e }), b())
                          })
                        : b()
                    },
                    onChange: (e) => A(e, h),
        ...
        L = () => {
          const { cv: e, putCvInfo: s, setCurrentData: i } = (0, x.A)(),
            { pet: a } = e.user.newData,
            { isOpen: o, onClose: c, onChange: d, text: p, onOpen: h } = D(a)
          S()
          return (0, g.jsxs)(n.s, {
            direction: 'column',
            w: '100%',
            ...
            pt: '20px',
            children: [
              (0, g.jsx)(V.E, { as: 'b', fontSize: 'larger', pb: '10px', children: 'Pet-project:' }),
              (0, g.jsxs)(n.s, {
                children: [
                  (0, g.jsxs)(t.a, {
                    children: [
                      ...
                      (0, g.jsx)(j, {
                        isOpen: o,
                        onSubmit: () => {
                          a.task && a.technologies && a.own && a.responsibilities
                            ? s(p, e).then(() => {
                                ;(i({ section: 'strPet', localData: a }), c())
                              })
                            : c()
                        },
                        text: p,
        ...
        _ = () =>
          (0, g.jsxs)(V.E, {
            pt: '20px',
            children: [
              (0, g.jsx)(V.E, { as: 'b', fontSize: 'larger', children: 'PET-Projects not in progress' }),
              '\xa0(In Progress):',
              (0, g.jsx)('br', {}),
              (0, g.jsx)(V.E, { as: 'samp', fontSize: 'large', children: 'Integral-shop' }),
              ':\xa0https://integral-bootstrap-redux.netlify.app',
              (0, g.jsx)('br', {}),
              (0, g.jsx)(V.E, { as: 'samp', fontSize: 'large', children: 'Task' }),
              ':\xa0Create shop from scratch.',
              (0, g.jsx)('br', {}),
              (0, g.jsx)(V.E, { as: 'samp', fontSize: 'large', children: 'Technologies' }),
              ':\xa0Node.js (Express), Bootstrap, Redux, React Hooks, MongoDB, Netlify, Heroku.',
              (0, g.jsx)('br', {}),
              (0, g.jsx)(V.E, { as: 'samp', fontSize: 'large', children: 'Responsibilities' }),
              ':\xa0Develop store structure, design, accessibility, responsive, routing, sorting, product filter, global search, feedback form.',
              (0, g.jsx)('br', {}),
              (0, g.jsx)('br', {}),
              (0, g.jsx)(V.E, { as: 'samp', fontSize: 'large', children: 'Craft-House' }),
              ':\xa0https://craft-house.netlify.app/ // React Classic',
              (0, g.jsx)('br', {}),
              (0, g.jsx)(V.E, { as: 'samp', fontSize: 'large', children: 'Task' }),
              ':\xa0SPA (Lending)',
              (0, g.jsx)('br', {}),
              (0, g.jsx)(V.E, { as: 'samp', fontSize: 'large', children: 'Technologies' }),
              ':\xa0React, Module CSS, MongoDB, Netlify.',
              (0, g.jsx)('br', {}),
              (0, g.jsx)(V.E, { as: 'samp', fontSize: 'large', children: 'Responsibilities' }),
              ':\xa0Design, Modal window f or filling and save form in database.',
              (0, g.jsx)('br', {}),
              'https://t1001t-goit-react-hw-04-movies.netlify.app/ // search movies rank // React classic',
              (0, g.jsx)('br', {}),
              (0, g.jsx)(V.E, { as: 'samp', fontSize: 'large', children: 'Task' }),
              ':\xa0Site movie, navigation bar for page, search movie, page details for movie, button \u201cGo to back\u201d previous page.',
              (0, g.jsx)('br', {}),
              (0, g.jsx)(V.E, { as: 'samp', fontSize: 'large', children: 'Technologies' }),
              ':\xa0React JS, Module CSS, Netlify CLI, API the movie db.',
              (0, g.jsx)('br', {}),
              (0, g.jsx)(V.E, { as: 'samp', fontSize: 'large', children: 'Responsibilities' }),
              ':\xa0Create pages for site, navigation bar, search movie, page details, button push local storage, React Routing.',
              (0, g.jsx)('br', {}),
              'https://f inder-images-on-react.netlify.app/ // React classic search photo animals, car, dog, bird, cat, etc.',
              (0, g.jsx)('br', {}),
              (0, g.jsx)(V.E, { as: 'samp', fontSize: 'large', children: 'Task' }),
              ':\xa0Site search images, create card, modal page.',
              (0, g.jsx)('br', {}),
              (0, g.jsx)(V.E, { as: 'samp', fontSize: 'large', children: 'Technologies' }),
              ':\xa0React JS, Module CSS, Netlify CLI, API pixabay.',
              (0, g.jsx)('br', {}),
              (0, g.jsx)(V.E, { as: 'samp', fontSize: 'large', children: 'Responsibilities' }),
              ':\xa0 Page, Rendering Card, Modal page',
            ],
          })
      var $ = i(8939)
      const M = (e) => {
          let { children: s } = e
          return (0, g.jsx)($.m, { maxW: '794px', minH: '1123px', p: 0, bg: 'white', children: s })
        },
        W = (e) => {
          let { children: s } = e
          return (0, g.jsx)(n.s, {
      ...
      const J = JSON.parse(
        ...
        U = () => {
          const e = (0, P.d)({ position: 'top-right' }),
            { accessToken: s, cv: i, user: a, pushCvText: t, hasChanged: o } = (0, x.A)()
          return (0, g.jsx)(q.T, {
            spacing: 3,
            align: 'stretch',
            children: (0, g.jsxs)(n.s, {
              ...
              children: [
                (0, g.jsx)(V.E, { children: 'Save CV' }),
                (0, g.jsx)(N.m, {
                  label: !o && 'Any text must be changed before saving!',
                  ...
                  children: (0, g.jsx)(r.$, {
                    ...
                    onClick: async (n) => {
                      if ((n.preventDefault(), s))
                        try {
                          const s = t({
                            newData: i.user.newData,
                            email: null === a || void 0 === a ? void 0 : a.userData.email,
                          }).then((e) => (e && e.data ? e : Promise.reject(new Error('Invalid response from server'))))
                          ;((0, T.E)(e, s), (0, O.vV)('Note sent successfully'))
                        } catch (o) {
                          ;(0, O.vV)(o)
                        }
                      else (0, O.vV)('Access token not available')
                    },
                    isDisabled: !o,
                    rightIcon:
                      o && (0, g.jsx)(H.A, { loop: !0, animationData: J, play: o, style: { width: 50, height: 50 } }),
                    children: 'Save',
                  }),
                }),
              ],
        ...
        K = () => {
          const { cv: e, putCvInfo: s, setCurrentData: i } = (0, x.A)(),
            { competencies: a } = e.user.newData,
            { text: o, onClose: c, onOpen: d, onChange: p, isOpen: h } = D(a)
          S()
          return (0, g.jsxs)(n.s, {
            direction: 'column',
            w: '100%',
            ...
            pt: '20px',
            children: [
              (0, g.jsx)(V.E, { as: 'b', fontSize: 'larger', pb: '10px', children: 'Competencies:' }),
              (0, g.jsxs)(n.s, {
                children: [
                  (0, g.jsxs)(t.a, {
                    children: [
                      ...
                      (0, g.jsx)(j, {
                        isOpen: h,
                        onSubmit: () => {
                          a.languages && a.ide && a.vcs && a.platform && a.tracking && a.db && a.technologies
                            ? s(o, e).then(() => {
                                ;(i({ section: 'strCompetencies', localData: a }), c())
                              })
                            : c()
                        },
                        text: o,
        ...
        Y = () => {
          const { user: e, getCvInfo: s } = (0, x.A)(),
            { email: i } = e.userData
          return (
            (0, a.useEffect)(() => {
              s(i).then()
      ...
      var X = i(74),
        Q = i.n(X)
      const Z = () => {
          const { cvPdfUp: e } = (0, x.A)()
          return (0, g.jsx)(t.a, {
            children: (0, g.jsx)(r.$, {
              onClick: async () => {
                try {
                  const s = await e({ url: ''.concat('http://localhost:3000', '/cv') }),
                    i = window.URL.createObjectURL(new Blob([s], { type: 'application/pdf' })),
                    a = document.createElement('a')
                  ;((a.href = i), (a.download = 'cv.pdf'), a.click(), a.remove())
                } catch (s) {
                  ;(0, O.vV)('PDF response error:', s)
                }
              },
              children: 'PDF',
            }),
        ...
        ee = (e) => {
          ...
          return (0, g.jsxs)(t.a, {
            ...
            children: [
              ...
              (0, g.jsx)(t.a, { ref: i, mt: 4, children: s }),
            ],
          })
        }
      var se = i(6221)
      const ie = () => {
        const { accessToken: e } = (0, x.A)()
        return (0, g.jsx)(ee, {
          children: e
            ? (0, g.jsx)(Y, {})
            : (0, g.jsx)(se.A, {
                children: (0, g.jsx)(t.a, { children: 'Form of CV are available only to logged-in users.' }),
              }),
        })
      }
    },
...
//# sourceMappingURL=585.4aae421b.chunk.js.map
